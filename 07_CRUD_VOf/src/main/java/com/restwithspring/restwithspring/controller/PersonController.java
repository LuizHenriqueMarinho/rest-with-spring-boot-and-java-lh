...
import com.restwithspring.restwithspring.vo.v2.PersonVOV2;
...
public class PersonController {
	...
	@RequestMapping(value = "/v2", 
			...
			consumes = MediaType.APPLICATION_JSON_VALUE,
			produces = MediaType.APPLICATION_JSON_VALUE)//produz o JSON
	public PersonVOV2 createV2(@RequestBody PersonVOV2 person) { //o @RequestBody pega as informações no body, assim como no postman		
