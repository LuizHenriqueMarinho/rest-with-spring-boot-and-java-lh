...
import com.restwithspring.restwithspring.util.MediaType;
...
public class PersonController {
	...
	@RequestMapping(method=RequestMethod.GET,
			        produces = {MediaType.APPLICATION_JSON,//produz o JSON, n precisa dessa notação com o GetMapping
	...
	@RequestMapping(method=RequestMethod.POST,
			...
			produces = {MediaType.APPLICATION_JSON,//produz o JSON, n precisa dessa notação com o GetMapping
			        	MediaType.APPLICATION_XML,
			        	MediaType.APPLICATION_YML})
	public PersonVO create(@RequestBody PersonVO person) throws Exception { //o @RequestBody pega as informações no body, assim como no postman		
	...
	@PutMapping(value = "/{id}",
			...
			produces = {MediaType.APPLICATION_JSON,//produz o JSON, n precisa dessa notação com o GetMapping
			        	MediaType.APPLICATION_XML,
			        	MediaType.APPLICATION_YML})
	public PersonVO update(@RequestBody PersonVO person, @PathVariable Long id) throws Exception{ //o @RequestBody pega as informações no body, assim como no postman		
